...
class ResnetBuilder(object):
    @staticmethod
    def build(input_shape, num_outputs, block_fn, repetitions,nb_filter):
        ...
        block_output = Activation("relu")(block)
    ...
    @staticmethod
    def build_resnet_2x2(input_shape, num_outputs,nb_filter):
        return ResnetBuilder.build(input_shape, num_outputs, basic_block, [2, 2, 2, 2],nb_filter)
    @staticmethod
    def build_resnet_a(input_shape, num_outputs,nb_filter):
        return ResnetBuilder.build(input_shape, num_outputs, basic_block, [1, 1, 1, 1],nb_filter)
    @staticmethod
    def build_resnet_b(input_shape, num_outputs,nb_filter):
        return ResnetBuilder.build(input_shape, num_outputs, basic_block, [1, 1, 1, 2],nb_filter)
    @staticmethod
    def build_resnet_c(input_shape, num_outputs,nb_filter):
        return ResnetBuilder.build(input_shape, num_outputs, basic_block, [1, 1, 2, 1],nb_filter)
    @staticmethod
    def build_resnet_d(input_shape, num_outputs,nb_filter):
        return ResnetBuilder.build(input_shape, num_outputs, basic_block, [1, 2, 1, 1],nb_filter)
    @staticmethod
    def build_resnet_e(input_shape, num_outputs,nb_filter):
        return ResnetBuilder.build(input_shape, num_outputs, basic_block, [2, 1, 1, 1],nb_filter)
    @staticmethod
    def build_resnet_f(input_shape, num_outputs,nb_filter):
        return ResnetBuilder.build(input_shape, num_outputs, basic_block, [1, 2, 2, 2],nb_filter)
    @staticmethod
    def build_resnet_h(input_shape, num_outputs,nb_filter):
        return ResnetBuilder.build(input_shape, num_outputs, basic_block, [1, 1, 2, 2],nb_filter)
    @staticmethod
    def build_resnet_i(input_shape, num_outputs,nb_filter):
        return ResnetBuilder.build(input_shape, num_outputs, basic_block, [2, 2, 1, 1],nb_filter)
    @staticmethod
    def build_resnet_j(input_shape, num_outputs,nb_filter):
        return ResnetBuilder.build(input_shape, num_outputs, basic_block, [2, 2, 1, 1],nb_filter)
    @staticmethod
    def build_resnet_k(input_shape, num_outputs,nb_filter):
        return ResnetBuilder.build(input_shape, num_outputs, basic_block, [1, 2, 1, 2],nb_filter)
    @staticmethod
    def build_resnet_l(input_shape, num_outputs,nb_filter):
        return ResnetBuilder.build(input_shape, num_outputs, basic_block, [2, 1, 2, 1],nb_filter)
